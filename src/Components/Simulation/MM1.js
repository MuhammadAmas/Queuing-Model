...
function mm1Simulation(lambda, mu, numCustomers) {
  let arrivalTime = [];
  let startTime = [];
  let endTime = [];
  let serviceTime = [];
...
export default function MM1() {
  ...
  function createData(arrivalTime, startTime, endTime, serviceTime, turnaroundTime, waitTime, responseTime) {
    return { arrivalTime, startTime, endTime, serviceTime, turnaroundTime, waitTime, responseTime };
  }
